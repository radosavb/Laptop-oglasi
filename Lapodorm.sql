...
values ('Lenovo Thinkpad T440p',15000,'thinkpadt440p.jpg','Intel Core i5','i5-5200U 2 cores 4 threads','8','DDR3','Integrisana','Intel HD5500','14','IPS ekran 1080p','1024','Toshiba 1TB sata3','256','SanDisk SSD','Nema',
'U odlicnom stanju. Ocuvan.','Beograd',0,'2019-09-17',1);

insert into oglas (naziv,cena,slika,cpu,cpu_opis,ram,tip_rama,gpu,gpu_opis,ekran,ekran_opis,hdd1,hdd1_opis,hdd2,hdd2_opis,os,slob_opis,lokacija,garancija,datum_oglasa,user_id) 
values ('HP Elitebook 8570p',26000,'hp8570p.jpg','Intel Core i7','Intel(R) Core i7-3520M 3.60GHz Turbo clock, 2.90GHz Base clock','8','DDR3','Integrisana','Intel HD400','15.6','IPS ekran 900p','Nema',null,'256','Intel SSD','Nema',
...
insert into oglas (naziv,cena,slika,cpu,cpu_opis,ram,tip_rama,gpu,gpu_opis,ekran,ekran_opis,hdd1,hdd1_opis,hdd2,hdd2_opis,os,slob_opis,lokacija,garancija,datum_oglasa,user_id) 
values ('Toshiba Protege Z930',25000,'toshibaz930.jpg','Intel Core i5','Intel(R) Core i5-3437U 2.9GHz Turbo clock, 1.9GHz Base clock','6','DDR3','Integrisana','Intel HD4000','14','IPS ekran 768p','Nema',null,'128','Transcend SSD','Windows',
...
insert into oglas (naziv,cena,slika,cpu,cpu_opis,ram,tip_rama,gpu,gpu_opis,ekran,ekran_opis,hdd1,hdd1_opis,hdd2,hdd2_opis,os,slob_opis,lokacija,garancija,datum_oglasa,user_id) 
values ('Lenovo ThinkPad T450',37000,'thinkpadt450.jpg','Intel Core i5',' Intel(R) Core i5-5300U 2.900GHz Turbo clock, 2.30GHz Base clock Quad core (4 logička, odnsono, 2 fizička jezgra)','16','DDR3','Integrisana','Intel HD5500','14','IPS ekran 900p','1024','WD 1TB sata3','256','Samsung SSD','Windows',
...
insert into oglas (naziv,cena,slika,cpu,cpu_opis,ram,tip_rama,gpu,gpu_opis,ekran,ekran_opis,hdd1,hdd1_opis,hdd2,hdd2_opis,os,slob_opis,lokacija,garancija,datum_oglasa,user_id) 
values ('Dell Latitude E6420',20000,'dellE6420.jpg','Intel Core i5','Intel Core i5-2520M Quad core 2.53GHz','8','DDR3','Integrisana','Intel HD3000','14','IPS ekran 768p','512','Seagate 512GB sata3','Nema',null,'Windows',
...
insert into oglas (naziv,cena,slika,cpu,cpu_opis,ram,tip_rama,gpu,gpu_opis,ekran,ekran_opis,hdd1,hdd1_opis,hdd2,hdd2_opis,os,slob_opis,lokacija,garancija,datum_oglasa,user_id) 
values ('HP Proobook 6550b',18000,'probook6550.jpg','Intel Core i5','Intel Core i5-540M Quad core 2.53GHz','4','DDR3','Integrisana','Intel HD2500','15.6','IPS ekran 768p','512','Toshiba 512GB sata3','Nema',null,'Windows',
